...
export const Description = () => {
    return (
        <div className="w-80 m-5">
            ...
            <p>- Choisissez votre ligue, le nombre de participants et vos critères préférés pour chaque secteur de jeu dans le formulaire suivant </p>
            <p>- Un algorithme d&apos;optimisation linéaire vous suggèrera une équipe et des enchères conformes à vos préférences.</p>
